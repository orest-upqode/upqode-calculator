...
function nextPrevButtons() {
    ...
    function createPriceTable() {
        ...
        let LOW_INIT_PRICE = 5000; // Начальная минимальная цена разработки
        let HIGH_INIT_PRICE = 7000; // Начальная высокая цена разработки
        ...
        const [rangeStyleRowHtml, lowCoef, highCoef] = calculateCoeficientForRange('range-style', 'Style of design', 2, 3, 4); // Последние 3 парамерта, это коэффициенты для дизайна
        const rangeYesNoCRMIntegration = calculatePriceForRangeYesNo('additional-range-crm', 'CRM Integration', 100); // Последний парамерт - цена за CRM Integration
        const rangeYesNoNewsletterIntegration = calculatePriceForRangeYesNo('additional-range-newsletter', 'Newsletter Integration', 100); // Последний парамерт - цена за Newsletter Integration
        const rangeYesNoLiveChatIntegration = calculatePriceForRangeYesNo('additional-range-livechat', 'LiveChat Integration', 100); // Последний парамерт - цена за LiveChat Integration
        const rangeYesNoOnlineBookings = calculatePriceForRangeYesNo('additional-range-bookings', 'Online Bookings', 100); // Последний парамерт - цена за Online Bookings
        const rangeYesNoGoogleMap = calculatePriceForRangeYesNo('additional-range-googlemap', 'Google Map Stylization', 100); // Последний парамерт - цена за Google Map Stylization
        const rangeYesNoAccessiBeTool = calculatePriceForRangeYesNo('additional-range-accessibe', 'AccessiBe Tool', 100); // Последний парамерт - цена за AccessiBe Tool
        const rangeYesNoComplexSearch = calculatePriceForRangeYesNo('additional-range-search', 'Complex Search', 100); // Последний парамерт - цена за Complex Search
        const rangeYesNoForum = calculatePriceForRangeYesNo('additional-range-forum', 'Forum', 100); // Последний парамерт - цена за Forum
        const rangeYesNoMembershipPortal = calculatePriceForRangeYesNo('additional-range-membership', '3rd Party Membership Portal', 100); // Последний парамерт - цена за 3rd Party Membership Portal
        const rangeYesNoMultilanguage = calculatePriceForRangeYesNo('additional-range-multilanguage', 'Multilanguage Functionalty', 100); // Последний парамерт - цена за Multilanguage Functionalty
        const rangeYesNoABTestingFunctionality = calculatePriceForRangeYesNo('additional-range-abtesting', 'A/B Testing Functionality', 100); // Последний парамерт - цена за A/B Testing Functionality
        const rangeYesNoStickyNavbar = calculatePriceForRangeYesNo('additional-range-sticky-navbar', 'Sticky Navigation Bar', 100); // Последний парамерт - цена за Sticky Navigation Bar
        const rangeYesNoLogo = calculatePriceForRangeYesNo('additional-range-logo', 'Logo', 100); // Последний парамерт - цена за дизайн LOGO
        const [inputNumberRowHtml, lowPricePagesNumber, highPricePagesNumber] = calculatePriceForNumber('input-number', 'Number of pages', 20, LOW_INIT_PRICE, HIGH_INIT_PRICE, lowCoef, highCoef); // 3 парамерт - цена за одну страницу Development
        const [inputCopywriteRowHtml, lowPriceCopywritingNumber, highPriceCopywritingNumber] = calculatePriceForNumber('input-copywriting', 'Copywriting number of pages', 100); // Последний парамерт - цена за одну страницу Copywriting
        const [inputKeywordsResearchRowHtml, lowPriceKeywordsResearchNumber, highPriceKeywordsResearchNumber] = calculatePriceForNumber('input-keywords', 'KeyWords Research', 5); // Последний парамерт - цена за 1 KeyWords Research
        const [inputCustomIconsRowHtml, lowPriceCustomIconsNumber, highPriceCustomIconsNumber] = calculatePriceForNumber('input-icons', 'Custom Icon', 10); // Последний парамерт - цена за 1 Custom Icon
        const [inputIllustrationRowHtml, lowPriceIllustrationNumber, highPriceIllustrationNumber] = calculatePriceForNumber('input-illustration', 'Custom Illustration', 5); // Последний парамерт - цена за 1 Custom Illustration
        const [inputAnimatedIllustrationRowHtml, lowPriceAnimatedIllustrationNumber, highPriceAnimatedIllustrationNumber] = calculatePriceForNumber('input-animated-illustration', 'Animated Illustration', 25); // Последний парамерт - цена за 1 Animated Illustration
        const rangeAnimationRow = calculatePriceForRange('range-animation', 'Animation', 1000, 2000, 5000); // Последних 3 парамерты, это цена по уровнях за Animation
        const [rangeCmsRowHtml, lowPriceRanges, highPriceRanges] = calculatePriceForRange('range-cms', 'CMS', 1000, 2000, 5000); // Последних 3 парамерты, это цена по уровнях за CMS
